...
- What products are causing the most late shipments?
- Is this product category from a particular supplier?
- Is late shipments from a particular supplier?
- Is late shipments due to specific zip code? or location?
- Is late shipments due to specific warehouse location?
...
Whereas grouping by just `'prodCategory'` provides delays at product category level where it provides less insight to identify like its supplier or shipment address or delivery warehouse location. l
...
They can also see the percentage of shipments that have multiple product categories. This helps business to identify the root cause of late shipments and to improve the performance of their shipments. Also create plans to multiple shipments based on the product categories which can help in inventory management and to improve the performance of their shipments.
```{python}
